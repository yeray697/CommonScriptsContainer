namespace CommonScripts.View.MainForm
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.runTabControl = new CommonScripts.View.MainForm.Tabs.Run.RunTabControl();
            this.mtpConsole = new System.Windows.Forms.TabPage();
            this.consoleTabControl = new CommonScripts.View.MainForm.Tabs.Console.ConsoleTabControl();
            this.mtpSettings = new System.Windows.Forms.TabPage();
            this.settingsTabControl = new CommonScripts.View.MainForm.Tabs.Settings.SettingsTabControl();
            ...
            this.runTabControl.StatusClicked += new CommonScripts.CustomComponent.ScriptListBox.ScriptListAdapter.ScriptClickHandler(this.ChangeScriptStatus);
            this.runTabControl.ScriptAdded += new CommonScripts.CustomComponent.ScriptListBox.ScriptListAdapter.ScriptClickHandler(this.AddScript);
            this.runTabControl.ScriptDeleted += new CommonScripts.CustomComponent.ScriptListBox.ScriptListAdapter.ScriptClickHandler(this.RemoveScript);
            this.runTabControl.ScriptEdited += new CommonScripts.View.MainForm.Tabs.Run.RunTabControl.ScriptEditHandler(this.EditScript);
            // 
            // mtpConsole
            // 
            ...
            this.settingsTabControl.SaveClicked += new System.EventHandler(this.SaveSettingsButtonClicked);
            // 
            // drawerImageList
            // 
